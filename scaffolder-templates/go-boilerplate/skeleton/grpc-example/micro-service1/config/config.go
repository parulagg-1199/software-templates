...
// OtherServices is a structure for configure other services addresses
...
func ConfigurationWithEnv() {
	...
	Conf.OtherServices.MicroService2 = os.Getenv("MICROSERVICE2_HOST_ADDRESS")
	...
	if os.Getenv("MICROSERVICE1_HTTP_PORT") != "" {
		Conf.Service.Port = os.Getenv("MICROSERVICE1_HTTP_PORT")
	} else {
