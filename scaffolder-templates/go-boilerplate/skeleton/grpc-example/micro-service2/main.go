...
import (
	...
	"git.xenonstack.com/util/golang-boilerplate/grpc-example/micro-service2/src/services"
...
func main() {
	...
	confTrace.ServiceName = "grpc-user-indformation-service"
	...
	pb.RegisterUserInformationServer(server, serverInterface)

	// start server as grpc server
